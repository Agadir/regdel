...
<div class="block">
  ...
  <ul class="pager" id="table_controls">
    ...
    <li><a href="./{//entries/@next}">Next &#187; <img style="vertical-align:text-top;" src="{$RACK_MOUNT_PATH}/s/img/pkgs/docunext-webapp-icons/famfamfam/mini/arrow_right.gif" alt=""/></a></li>
  </ul>
</div></div>
</xsl:template>
